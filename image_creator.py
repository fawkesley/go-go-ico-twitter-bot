...
class ImageCreator():
    ...
    REGULAR_FONT = 'media/HelveticaNeue-CondensedBold.otf'
    BOLD_FONT = 'media/helvetica-neue-bold.ttf'

    DESCRIPTION_FONT = '/usr/share/fonts/truetype/freefont/FreeMonoBold.ttf'
    ...
    def load_canvas(self):
        ...
        """
        # TODO: actually load rather than generating a new one
        self.im = Image.open('media/background.png')
        # self.im = Image.new('RGB', (1200, 675), color=(241, 216, 121))
    ...
    def wrap(self, words, font, line_length_px):
        ...
        for word in words.split(' '):
            ...
            print('len {} `{}`'.format(len_pixels, line_longer))
